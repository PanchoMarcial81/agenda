...
<html lang="es">
  ...
  <body>
    ...
    <div  class="container">
      ...
      <div class="row">
        <div class="col-sm-12">  
          <a href="#addNew" class="btn btn-primary mb-2" data-toggle="modal" ><span class="fa fa-plus"></span> Nuevo</a>
          <?php 
            session_start();
          ...
          <table class="table table-bordered table-striped" id="MiAgenda" style="margin-top:20px; " >
            ...
            <tbody>
              <?php 
                ...
                $db = $database->open();
                try{
                  $sql = 'SELECT * FROM personas WHERE 1 ORDER BY personas.idPersona DESC';
